...
g++ -O3 -std=c++20 -march=native -mavx2 -maes -mpclmul -Wno-ignored-attributes new_test.cpp -o new_test -lboost_coroutine -lboost_context -pthread > /dev/null 2>&1
